module.exports = {
  ...
  ANNOUNCE_TIME_MIN: 15,          // 0-59. Similarily applies to both posting agenda and notifying due
  ANNOUNCE_DAY_OF_WEEK: 2,       // 0= Sunday, 1= Monday, ..., 6=Saturday, 7=Sunday
  ANNOUNCE_CHANNEL: '#announcements', // The channel to post the schedule on
  //Website
